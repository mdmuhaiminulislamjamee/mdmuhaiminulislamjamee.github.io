(async function () {
  ...
  const fallbackSearchIndex = [
    ...
    { title: "What Is a Robot?", url: "blog/what-is-a-robot.html", detail: "Beginner guide to robots, sensors, motors, microcontrollers, batteries, and Arduino" },
    { title: "Simple LED Project with Arduino", url: "blog/simple-led-project-arduino.html", detail: "Beginner Arduino LED circuit, wiring, resistor, and code" },
    { title: "First Obstacle-Avoiding Robot", url: "blog/obstacle-avoiding-robot.html", detail: "Arduino, ultrasonic sensor, motor driver, DC motors, circuit connections, and code" },
